...
var tabs = [{ title: "tab1", content: "This is tab1" }, { title: "tab2", content: "This is tab2" }, { title: "tab3 ", content: "  Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur impedit eius nesciunt accusantium aliquam sed ex ullam inventore, iste, ea sit qui enim veritatis assumenda obcaecati ipsum temporibus libero debitis." }];
  ...
  _createClass(Tabs, [{
          ...
          this.props.tabs.map(function (tab, idx) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                "h1",
                {
                  className: idx === parseInt(_this2.state.tabsIdx) ? "clicked-tab" : "",
                  idx: idx,
                  onClick: _this2.addClickHandler() },
                tab["title"]
              )
            );
          })
    ...
    value: function addClickHandler() {
      ...
      return function (event) {
        var tabsIdx = event.target.getAttribute('idx');
        _this3.setState({ tabsIdx: tabsIdx });
      };
    }
  }]);
...
var Weather = function (_React$Component) {
  ...
  _createClass(Weather, [{
    ...
    value: function fetchWeather() {
      ...
      var url = 'http://api.openweathermap.org/data/2.5/weather?lat=20&long=25';
      url += "&APPID=" + apiKey;
